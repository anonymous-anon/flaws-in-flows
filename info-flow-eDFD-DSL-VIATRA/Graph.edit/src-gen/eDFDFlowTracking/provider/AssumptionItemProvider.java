 ...
 * @generated
 */
public class AssumptionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addObjectivePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Assumption_Objective_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Assumption_Objective_feature",
								"_UI_Assumption_type"),
						EDFDFlowTrackingPackage.Literals.ASSUMPTION__OBJECTIVE, true, false, false,
	...
	protected void addLayerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Assumption_Layer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Assumption_Layer_feature",
								"_UI_Assumption_type"),
						EDFDFlowTrackingPackage.Literals.ASSUMPTION__LAYER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
