...
/**
 * This is the item provider adapter for a {@link graph.GraphAsset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphAssetItemProvider 
	 ...
	 * @generated
	 */
	public GraphAssetItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GraphAsset_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GraphAsset_source_feature", "_UI_GraphAsset_type"),
				 GraphPackage.Literals.GRAPH_ASSET__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GraphAsset_targets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GraphAsset_targets_feature", "_UI_GraphAsset_type"),
				 GraphPackage.Literals.GRAPH_ASSET__TARGETS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GraphAsset"));
	}
	...
	public String getText(Object object) {
		String label = ((GraphAsset)object).getID();
