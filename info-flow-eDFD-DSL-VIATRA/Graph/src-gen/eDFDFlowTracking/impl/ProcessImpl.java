...
public class ProcessImpl extends ElementImpl implements eDFDFlowTracking.Process {
	...
	public EList<Responsibility> getResponsibility() {
		if (responsibility == null) {
			responsibility = new EObjectContainmentWithInverseEList<Responsibility>(Responsibility.class, this,
					EDFDFlowTrackingPackage.PROCESS__RESPONSIBILITY, EDFDFlowTrackingPackage.RESPONSIBILITY__PROCESS);
		}
