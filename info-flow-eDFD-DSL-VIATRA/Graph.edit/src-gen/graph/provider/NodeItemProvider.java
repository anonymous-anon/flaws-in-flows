...
public class NodeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addAttackerObservationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_AttackerObservation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_AttackerObservation_feature",
								"_UI_Node_type"),
						GraphPackage.Literals.NODE__ATTACKER_OBSERVATION, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addVisitedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_visited_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_visited_feature", "_UI_Node_type"),
						GraphPackage.Literals.NODE__VISITED, true, false, false,
	...
	protected void addInedgesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_inedges_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_inedges_feature", "_UI_Node_type"),
						GraphPackage.Literals.NODE__INEDGES, true, false, true, null, null, null));
	}
	...
	protected void addAttackerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Node_Attacker_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Node_Attacker_feature", "_UI_Node_type"),
						GraphPackage.Literals.NODE__ATTACKER, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(GraphPackage.Literals.NODE__OUTEDGES, GraphFactory.eINSTANCE.createEdge()));

		newChildDescriptors.add(createChildParameter(GraphPackage.Literals.NODE__RESPONSIBILITY,
