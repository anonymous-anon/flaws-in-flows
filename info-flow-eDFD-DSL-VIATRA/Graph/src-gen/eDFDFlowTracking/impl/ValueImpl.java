...
public class ValueImpl extends MinimalEObjectImpl.Container implements Value {
	...
	public void setObjective(Objective newObjective) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.VALUE__OBJECTIVE,
	...
	public void setPriority(Priority newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.VALUE__PRIORITY, oldPriority,
					priority));
	}
