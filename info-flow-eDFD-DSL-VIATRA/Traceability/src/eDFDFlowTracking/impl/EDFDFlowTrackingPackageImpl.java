...
public class EDFDFlowTrackingPackageImpl extends EPackageImpl implements EDFDFlowTrackingPackage {
	...
	public static EDFDFlowTrackingPackage init() {
		...
		EDFDFlowTrackingPackageImpl theEDFDFlowTrackingPackage = (EDFDFlowTrackingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EDFDFlowTrackingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EDFDFlowTrackingPackageImpl());
