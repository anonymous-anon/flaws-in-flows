...
public class ElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EDFDFlowTrackingPackage.Literals.NAMED_ENTITY__NAME, true, false, false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NamedEntity_number_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_NamedEntity_number_feature",
								"_UI_NamedEntity_type"),
						EDFDFlowTrackingPackage.Literals.NAMED_ENTITY__NUMBER, true, false, false,
	...
	protected void addAssetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_assets_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Element_assets_feature",
								"_UI_Element_type"),
						EDFDFlowTrackingPackage.Literals.ELEMENT__ASSETS, true, false, true, null, null, null));
	}
	...
	protected void addAttackerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_Attacker_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Element_Attacker_feature",
								"_UI_Element_type"),
						EDFDFlowTrackingPackage.Literals.ELEMENT__ATTACKER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EDFDFlowTrackingPackage.Literals.ELEMENT__INFLOWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EDFDFlowTrackingPackage.Literals.ELEMENT__OUTFLOWS,
				EDFDFlowTrackingFactory.eINSTANCE.createFlow()));

		newChildDescriptors.add(createChildParameter(EDFDFlowTrackingPackage.Literals.ELEMENT__ASSUMPTION,
				EDFDFlowTrackingFactory.eINSTANCE.createAssumption()));

		newChildDescriptors.add(createChildParameter(EDFDFlowTrackingPackage.Literals.ELEMENT__INFLOWS,
				EDFDFlowTrackingFactory.eINSTANCE.createFlow()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == EDFDFlowTrackingPackage.Literals.ELEMENT__OUTFLOWS
				|| childFeature == EDFDFlowTrackingPackage.Literals.ELEMENT__INFLOWS;
