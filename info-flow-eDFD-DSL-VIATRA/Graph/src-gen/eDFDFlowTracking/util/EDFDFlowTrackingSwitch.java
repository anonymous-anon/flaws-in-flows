...
public class EDFDFlowTrackingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EDFDFlowTrackingPackage.PROCESS: {
			...
			if (result == null)
				result = caseNamedEntity(process);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EDFDFlowTrackingPackage.DATA_STORE: {
			...
			if (result == null)
				result = caseNamedEntity(dataStore);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EDFDFlowTrackingPackage.EXTERNAL_ENTITY: {
			...
			if (result == null)
				result = caseElement(externalEntity);
			if (result == null)
				result = caseNamedEntity(externalEntity);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case EDFDFlowTrackingPackage.ELEMENT: {
			...
			if (result == null)
				result = caseNamedEntity(element);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EDFDFlowTrackingPackage.ATTACKER_PROFILE: {
			...
			if (result == null)
				result = caseNamedEntity(attackerProfile);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case EDFDFlowTrackingPackage.TRUST_ZONE: {
			...
			if (result == null)
				result = caseElement(trustZone);
			if (result == null)
				result = caseNamedEntity(trustZone);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case EDFDFlowTrackingPackage.RESPONSIBILITY: {
			...
			if (result == null)
				result = caseNamedEntity(responsibility);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
