...
public class EDFDImpl extends MinimalEObjectImpl.Container implements EDFD {
	...
	public void setNumber(int newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.EDFD__NUMBER, oldNumber,
					number));
	}
	...
	public EList<TrustZone> getTrustzones() {
		if (trustzones == null) {
			trustzones = new EObjectContainmentEList<TrustZone>(TrustZone.class, this,
					EDFDFlowTrackingPackage.EDFD__TRUSTZONES);
		}
		return trustzones;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this,
					EDFDFlowTrackingPackage.EDFD__ELEMENTS);
		}
		return elements;
	}
