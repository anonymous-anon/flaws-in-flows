 ...
 * @generated
 */
public class ResponsibilityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Responsibility_Action_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Responsibility_Action_feature",
								"_UI_Responsibility_type"),
						EDFDFlowTrackingPackage.Literals.RESPONSIBILITY__ACTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIncomeassetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Responsibility_incomeassets_feature",
						"_UI_Responsibility_type"),
				EDFDFlowTrackingPackage.Literals.RESPONSIBILITY__INCOMEASSETS, true, false, true, null, null, null));
	}
	...
	protected void addOutcomeassetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Responsibility_outcomeassets_feature",
						"_UI_Responsibility_type"),
				EDFDFlowTrackingPackage.Literals.RESPONSIBILITY__OUTCOMEASSETS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Responsibility_type")
