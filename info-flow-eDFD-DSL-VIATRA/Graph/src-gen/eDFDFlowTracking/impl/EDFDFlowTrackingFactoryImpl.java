...
public class EDFDFlowTrackingFactoryImpl extends EFactoryImpl implements EDFDFlowTrackingFactory {
	...
	public static EDFDFlowTrackingFactory init() {
		try {
			EDFDFlowTrackingFactory theEDFDFlowTrackingFactory = (EDFDFlowTrackingFactory) EPackage.Registry.INSTANCE
					.getEFactory(EDFDFlowTrackingPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case EDFDFlowTrackingPackage.ATTACKER_PROFILE:
			return createAttackerProfile();
		case EDFDFlowTrackingPackage.TRUST_ZONE:
			return createTrustZone();
