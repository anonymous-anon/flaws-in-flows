...
public class AssetImpl extends MinimalEObjectImpl.Container implements Asset {
	...
	public void setNumber(int newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ASSET__NUMBER, oldNumber,
					number));
	}
	...
	public Element getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EDFDFlowTrackingPackage.ASSET__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(Element newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ASSET__SOURCE, oldSource,
					source));
	}
