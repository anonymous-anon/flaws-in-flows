...
public class ValueItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addObjectivePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Value_Objective_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Value_Objective_feature",
								"_UI_Value_type"),
						EDFDFlowTrackingPackage.Literals.VALUE__OBJECTIVE, true, false, false,
	...
	protected void addPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Value_Priority_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Value_Priority_feature", "_UI_Value_type"),
						EDFDFlowTrackingPackage.Literals.VALUE__PRIORITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
