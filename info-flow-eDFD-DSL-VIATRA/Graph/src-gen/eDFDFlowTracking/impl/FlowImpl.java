...
public class FlowImpl extends ElementImpl implements Flow {
	...
	public void setChannel(Channel newChannel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.FLOW__CHANNEL, oldChannel,
					channel));
	}
	...
	public Element getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EDFDFlowTrackingPackage.FLOW__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(Element newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.FLOW__SOURCE, oldSource,
					source));
	}
	...
	public void setLabel(int newLabel) {
		...
		label = newLabel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.FLOW__LABEL, oldLabel,
					label));
	}
