...
public class AssetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Asset_source_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Asset_source_feature", "_UI_Asset_type"),
						EDFDFlowTrackingPackage.Literals.ASSET__SOURCE, true, false, true, null, null, null));
	}
	...
	protected void addTargetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Asset_targets_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Asset_targets_feature", "_UI_Asset_type"),
						EDFDFlowTrackingPackage.Literals.ASSET__TARGETS, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EDFDFlowTrackingPackage.Literals.ASSET__VALUE,
