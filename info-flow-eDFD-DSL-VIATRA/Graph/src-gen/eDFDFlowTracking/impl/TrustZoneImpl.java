...
public class TrustZoneImpl extends ElementImpl implements TrustZone {
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<Element>(Element.class, this,
					EDFDFlowTrackingPackage.TRUST_ZONE__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<TrustZone> getSubzones() {
		if (subzones == null) {
			subzones = new EObjectContainmentEList<TrustZone>(TrustZone.class, this,
					EDFDFlowTrackingPackage.TRUST_ZONE__SUBZONES);
		}
		return subzones;
	}
	...
	public EList<AttackerProfile> getAttackerprofile() {
		if (attackerprofile == null) {
			attackerprofile = new EObjectContainmentEList<AttackerProfile>(AttackerProfile.class, this,
					EDFDFlowTrackingPackage.TRUST_ZONE__ATTACKERPROFILE);
		}
