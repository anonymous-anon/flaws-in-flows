 ...
 * @generated
 */
public class NodeResponsibilityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeResponsibility_outgoingassets_feature", "_UI_NodeResponsibility_type"),
				 GraphPackage.Literals.NODE_RESPONSIBILITY__OUTGOINGASSETS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeResponsibility_incomingassets_feature", "_UI_NodeResponsibility_type"),
				 GraphPackage.Literals.NODE_RESPONSIBILITY__INCOMINGASSETS,
				 true,
				 false,
				 true,
				 null,
