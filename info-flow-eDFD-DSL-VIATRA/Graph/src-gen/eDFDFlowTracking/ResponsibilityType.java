...
public enum ResponsibilityType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ResponsibilityType[] VALUES_ARRAY = new ResponsibilityType[] { STORE, COMPARATOR, DISCARDER,
			JOINER, COPIER, SPLITTER, FORWARD, ENCRYPT_OR_HASH, DECRYPT, AUTHENTICATOR, AUTHORISER, VERIFIER, USER, };
	...
	public static ResponsibilityType get(int value) {
		...
		case STORE_VALUE:
			return STORE;
		case COMPARATOR_VALUE:
			return COMPARATOR;
		case DISCARDER_VALUE:
			return DISCARDER;
		case JOINER_VALUE:
			return JOINER;
		case COPIER_VALUE:
		...
		case FORWARD_VALUE:
			return FORWARD;
		case ENCRYPT_OR_HASH_VALUE:
			return ENCRYPT_OR_HASH;
		case DECRYPT_VALUE:
			return DECRYPT;
		case AUTHENTICATOR_VALUE:
			return AUTHENTICATOR;
		case AUTHORISER_VALUE:
			return AUTHORISER;
		case VERIFIER_VALUE:
			return VERIFIER;
		case USER_VALUE:
