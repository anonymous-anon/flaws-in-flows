...
public class AssumptionImpl extends MinimalEObjectImpl.Container implements Assumption {
	...
	public EList<Objective> getObjective() {
		if (objective == null) {
			objective = new EDataTypeUniqueEList<Objective>(Objective.class, this,
					EDFDFlowTrackingPackage.ASSUMPTION__OBJECTIVE);
		}
		return objective;
	}
	...
	public void setLayer(Layer newLayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ASSUMPTION__LAYER, oldLayer,
					layer));
	}
