...
public class FlowItemProvider extends ElementItemProvider {
	...
	protected void addChannelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_Channel_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_Channel_feature", "_UI_Flow_type"),
						EDFDFlowTrackingPackage.Literals.FLOW__CHANNEL, true, false, false,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_target_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_target_feature", "_UI_Flow_type"),
						EDFDFlowTrackingPackage.Literals.FLOW__TARGET, true, false, true, null, null, null));
	}
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_source_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_source_feature", "_UI_Flow_type"),
						EDFDFlowTrackingPackage.Literals.FLOW__SOURCE, true, false, true, null, null, null));
	}
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_Label_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_Label_feature", "_UI_Flow_type"),
						EDFDFlowTrackingPackage.Literals.FLOW__LABEL, true, false, false,
