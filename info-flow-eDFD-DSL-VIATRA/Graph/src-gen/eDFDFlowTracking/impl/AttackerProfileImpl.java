...
public class AttackerProfileImpl extends MinimalEObjectImpl.Container implements AttackerProfile {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ATTACKER_PROFILE__NAME,
					oldName, name));
	}
	...
	public void setNumber(int newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ATTACKER_PROFILE__NUMBER,
					oldNumber, number));
	}
	...
	public void setObservation(int newObservation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ATTACKER_PROFILE__OBSERVATION,
