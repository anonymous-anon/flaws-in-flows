...
public class GraphValidator extends EObjectValidator {
	...
	public boolean validateGraphAsset(GraphAsset graphAsset, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(graphAsset, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validateGraphAsset_AttackerObservationViolationSource(graphAsset, diagnostics, context);
		if (result || diagnostics != null) result &= validateGraphAsset_AttackerObservationViolationTagret(graphAsset, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateGraphAsset_AttackerObservationViolationSource(GraphAsset graphAsset, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(GraphPackage.Literals.GRAPH_ASSET,
				 graphAsset,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "AttackerObservationViolationSource",
				 GRAPH_ASSET__ATTACKER_OBSERVATION_VIOLATION_SOURCE__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
	 ...
	 * @generated
	 */
	public boolean validateGraphAsset_AttackerObservationViolationTagret(GraphAsset graphAsset, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(GraphPackage.Literals.GRAPH_ASSET,
				 graphAsset,
				 ...
				 GRAPH_ASSET__ATTACKER_OBSERVATION_VIOLATION_TAGRET__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				 "AttackerObservationViolation",
				 NODE__ATTACKER_OBSERVATION_VIOLATION__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__ENCRYPT_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__DECRYPT_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__STORE_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__BUSINESS_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__COMPARATOR_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__JOINER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__DISCARDER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__COPIER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__FORWARD_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__SPLITTER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__USER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__VERIFIER_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
		...
		return
			validate
				(GraphPackage.Literals.NODE,
				 ...
				 NODE__AUTHENTICATOR_SEMANTIC_CONSTRAINT__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
