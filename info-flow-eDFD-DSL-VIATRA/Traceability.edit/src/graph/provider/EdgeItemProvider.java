	...
	protected void addGraphassetsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_graphassets_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_graphassets_feature", "_UI_Edge_type"),
				 GraphPackage.Literals.EDGE__GRAPHASSETS,
				 true,
				 false,
				 true,
				 null,
