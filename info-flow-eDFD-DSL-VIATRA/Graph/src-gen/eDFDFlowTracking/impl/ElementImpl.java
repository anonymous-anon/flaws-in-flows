...
public abstract class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ELEMENT__NAME, oldName,
					name));
	}
	...
	public void setNumber(int newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ELEMENT__NUMBER, oldNumber,
					number));
	}
	...
	public EList<Assumption> getAssumption() {
		if (assumption == null) {
			assumption = new EObjectContainmentEList<Assumption>(Assumption.class, this,
					EDFDFlowTrackingPackage.ELEMENT__ASSUMPTION);
		}
		return assumption;
	}
	...
	public void setAttacker(boolean newAttacker) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EDFDFlowTrackingPackage.ELEMENT__ATTACKER,
